...
(library Library_1
	...
	(patternDef "ABEZD10CA3K65" (originalName "ABEZD10CA3K65")
		(multiLayer
	...
	(symbolDef "AB-EZD10C-A3-K65" (originalName "AB-EZD10C-A3-K65")
	...
	(compDef "AB-EZD10C-A3-K65" (originalName "AB-EZD10C-A3-K65") (compHeader (numPins 2) (numParts 1) (refDesPrefix LED)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "AB-EZD10C-A3-K65"))
		(attachedPattern (patternNum 1) (patternName "ABEZD10CA3K65")
			(numPads 2)
			(padPinMap
		...
		(attr "Manufacturer_Part_Number" "AB-EZD10C-A3-K65")
		(attr "Mouser Part Number" "")
		(attr "Mouser Price/Stock" "")
		(attr "Arrow Part Number" "")
		(attr "Arrow Price/Stock" "")
		(attr "Description" "White LEDs 1.0W, 12V, CCT 6500K, CRI80, 3030 EMC, DC ezyLED")
